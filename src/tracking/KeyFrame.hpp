...
#ifndef _MC_VEO_KEY_FRAME_HPP_
#define _MC_VEO_KEY_FRAME_HPP_

#include <mc-veo/utils/Utils.hpp>
#include <mc-veo/utils/KDTree.hpp>
#include <mc-veo/mapping/Types.hpp>
#include <mc-veo/mapping/DepthPoints.hpp>
