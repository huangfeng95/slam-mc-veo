...
struct PointHessian
{
    ...
    // static values
    float color[MAX_RES_PER_POINT];			// grayscale in host frame
    float red[MAX_RES_PER_POINT];			// red channel in host frame
    float green[MAX_RES_PER_POINT];			// green channel in host frame
    float blue[MAX_RES_PER_POINT];			// blue channel in host frame
