...
public:
	...
	float red[MAX_RES_PER_POINT];
	float green[MAX_RES_PER_POINT];
	float blue[MAX_RES_PER_POINT];
	...
	ImmaturePoint(int u_, int v_, FrameHessian* host_, float type, CalibHessian* HCalib,
                const unsigned char *red=nullptr,  const unsigned char *green=nullptr,  const unsigned char *blue=nullptr);
    ImmaturePoint(int u_, int v_, FrameHessian* host_, float type, float idepth, double distance, CalibHessian* HCalib,
                const unsigned char *red=nullptr,  const unsigned char *green=nullptr,  const unsigned char *blue=nullptr);
	~ImmaturePoint();
