...
#include "mc-veo/utils/nanoflann.h"
...
bool CoarseInitializer::trackFrame(FrameHessian* newFrameHessian, const int &snapped_threshold)
{
    ...
    return snapped && frameID > snappedAt+snapped_threshold;
}
...
{
    float factor = 1.0*thisToNext.translation().norm();
    return factor;
}
